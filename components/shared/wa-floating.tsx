...
export function WAFloating() {
    ...
    return (
        <Link
            ...
            className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-blue-600 shadow-lg transition-transform hover:scale-110 hover:bg-blue-700 animate-in fade-in slide-in-from-bottom-4 duration-1000"
