                            ...
                            <ul className="space-y-8">
                                <li className="flex items-start gap-5">
                                    ...
                                    <div>
                                        ...
                                        <p className="leading-relaxed text-slate-100 font-medium">{SITE_CONFIG.address}</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-5">
                                    <div className="w-12 h-12 rounded-xl bg-blue-600/10 flex items-center justify-center shrink-0 border border-blue-600/20">
                                    ...
                                    <div>
                                        ...
                                        <p className="leading-relaxed text-slate-100 font-medium">{SITE_CONFIG.phone}</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-5">
                                    <div className="w-12 h-12 rounded-xl bg-blue-600/10 flex items-center justify-center shrink-0 border border-blue-600/20">
                                    ...
                                    <div>
                                        ...
                                        <p className="leading-relaxed text-slate-100 font-medium">{SITE_CONFIG.email}</p>
                                    </div>
                                </li>
                                <li className="flex items-start gap-5">
                                    <div className="w-12 h-12 rounded-xl bg-blue-600/10 flex items-center justify-center shrink-0 border border-blue-600/20">
                                    ...
                                    <div>
                                        ...
                                        <p className="leading-relaxed text-slate-100 font-medium whitespace-pre-line">
                                            {t.contactPage.info.hoursDesc}
                                        </p>
                                    </div>
                                </li>
                            </ul>
