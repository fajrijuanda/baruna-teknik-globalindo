      ...
      services: [
        {
          ...
          descriptionId:
            "PT. Baruna Teknik Globalindo hadir sebagai spesialis terpercaya dalam solusi Pump Specialist & Electric Motors. Kami menyediakan berbagai pilihan pompa industri dan motor listrik berkualitas tinggi untuk mendukung kelancaran kegiatan operasional perusahaan Anda. Tersedia rangkaian produk lengkap, mulai dari pompa sentrifugal, submersible, hingga berbagai spesifikasi motor listrik (induksi/dinamo) yang handal. Lebih dari sekadar penyedia unit, tim ahli kami juga selalu siap memberikan panduan teknis—mulai dari konsultasi pemilihan unit yang paling pas, proses instalasi yang rapi, hingga layanan purna jual yang terjamin. Komitmen kami sederhana: kami memastikan efisiensi energi dan keandalan sistem rotasi mesin Anda, sehingga meminimalkan risiko downtime dan produktivitas industri tetap terjaga maksimal.",
          descriptionEn:
            "PT. Baruna Teknik Globalindo serves as a trusted specialist in Pump & Electric Motor solutions. We provide a wide selection of high-quality industrial pumps and electric motors to ensure the smooth operation of your business. Our complete product range includes everything from centrifugal and submersible pumps to various reliable electric motor specifications. More than just a supplier, our expert team is always ready to provide technical guidance—starting from consulting on the most suitable unit, through professional installation, to guaranteed after-sales service. Our commitment is simple: we ensure energy efficiency and the reliability of your machinery, minimizing downtime risks and maximizing your industrial productivity.",
        },
        {
          titleId: "General Trading",
          titleEn: "General Trading",
          descriptionId:
            "Melalui layanan General Supply, PT. Baruna Teknik Globalindo hadir untuk memenuhi segala kebutuhan barang dan perlengkapan industri Anda. Kami menawarkan beragam produk yang sangat lengkap, mulai dari alat perkakas, perlengkapan kelistrikan, sistem pneumatik, alat keselamatan kerja (K3), hingga bahan kebutuhan harian seperti pelumas dan pembersih khusus industri. Dengan dukungan jaringan supplier kami yang luas dan sangat terpercaya, Anda bisa mendapatkan produk-produk berkualitas unggulan dengan harga yang jauh lebih kompetitif. Layanan ini kami rancang secara khusus untuk mempermudah kegiatan operasional harian Anda, memastikan pengadaan barang selalu cepat dan efisien. Dengan begitu, perusahaan bisa lebih fokus pada bisnis utamanya, tanpa pusing memikirkan stok barang yang menipis.",
          descriptionEn:
            "Through our General Supply service, PT. Baruna Teknik Globalindo is here to fulfill all your industrial goods and equipment needs. We offer a highly comprehensive range of products, including hand and power tools, electrical equipment, pneumatic systems, occupational safety gear (HSE), as well as daily consumables like industrial lubricants and specialized cleaners. Backed by our extensive and highly trusted supplier network, you can obtain premium-quality products at much more competitive prices. This service is specifically designed to simplify your daily operations, ensuring procurement is always fast and efficient. This way, your company can focus more on its core business without worrying about depleting supply stocks.",
        },
      ],
    },
  },
